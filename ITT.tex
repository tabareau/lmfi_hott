...
A positive type has the form $(c_1 : P_1 \oplus ... \oplus c_n :
P_n)_{w:P}$ where $w$ are the parameters of the type and the $c_i$ are
...
Substitution of $\rho$ by $w$ is as expected.
...
\\
  \begin{array}{lcll}
t, u, v, A, B, p, q & ::= & \ldots ~|~ \case{t}{[ c_1 \rho \mapsto t | ... | c_n \rho \mapsto t ]} ~|~ c_i w ~|~ 
(c_1 : P \oplus ... \oplus c_n : P)_{w:P}\\
P & ::= & 1 ~|~ (a:A) \otimes P\\
w & ::= & () ~|~ (t,w)\\
\rho & ::= & () ~|~ (a,\rho)\\
\Gamma & ::= & ... ~|~ \rho : P\\
...
\seqr{}
     {}
     {\Gamma \vdash 1 : \sort{l}}
\qquad
\seqr{}
     {\Gamma \vdash A : \sort{l} \qquad \Gamma, a : A \vdash P : \sort{l}}
     {\Gamma \vdash (a : A) \otimes P : \sort{l}}
\qquad
\seqr{}
     {\Gamma \vdash P : \sort{l} \qquad \Gamma, \rho : P \vdash P_i : \sort{l} \quad (1 \leq i \leq n) \qquad \Gamma \vdash w : P}
     {\Gamma \vdash (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w:P} : \sort{l}}
\\
\\
\begin{array}{ccc}
...
\qquad
\seqr{}
     {\Gamma \vdash t : A \qquad \Gamma \vdash w : \Sub{P}{a}{t}}
     {\Gamma \vdash (t,w) : (a:A) \otimes P}
&\qquad&
\seqr{}
     {}
     {\Gamma \vdash_d () : 1}
\qquad
\seqr{}
     {\Gamma \vdash A : \sort{l} \qquad \Gamma, a : A \vdash_d \rho : P}
     {\Gamma \vdash_d (a,\rho) : (a:A) \otimes P}
\qquad
\seqr{}
     {\wfctx{\Gamma} \qquad \Gamma \vdash_d \rho : P}
     {\wfctx{\Gamma, \rho : P}}
\end{array}
\\
\\
...
\\
\seqr{(1 \leq i \leq n)}
     {\Gamma \vdash P : \sort{l} \qquad \Gamma, \rho : P \vdash P_j : \sort{l} \quad (1 \leq j \leq n) \qquad \Gamma \vdash w' : P \qquad \Gamma \vdash w : P_i}
     {\Gamma \vdash c_i w : (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w':P}}
\\
\\
\mbox{\em elimination rule}
\\
\\
\seqr{}
     {\Gamma, a : (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w:P} \vdash B : \sort{l} \qquad \Gamma, \rho : P_i \vdash t_i : \Sub{B}{a}{c_i\,\rho} \quad (1 \leq i \leq n) \qquad \Gamma \vdash v : (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w:P}}
...
\\
\seqr{\poseta}
     {\Gamma, a : (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w:P} \vdash E[a] : A \qquad \Gamma \vdash v : (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w:P}}
...
\\
\seqr{}
     {\Gamma \vdash P_i \equiv P_i' : \sort{l} \quad (1 \leq i \leq n) \qquad \Gamma \vdash P \equiv P' : \sort{l} \qquad \Gamma \vdash w \equiv w' : P }
     {\Gamma \vdash (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w:P} \equiv (c_1 : P'_1 \oplus ... \oplus c_n : P'_n)_{w':P'} : \sort{l}}
\\
\\
\seqr{}
     {\Gamma \vdash P : \sort{l} \qquad \Gamma, \rho : P \vdash P_i : \sort{l} \quad (1 \leq i \leq n) \qquad \Gamma \vdash w'' : P \qquad \Gamma \vdash w \equiv w' : P_i}
     {\Gamma \vdash c_i\,w \equiv c_i\,w' : (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w'':P}}
\\
\\
\seqr{}
     {\Gamma, a : (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w:P} \vdash B : \sort{l} \qquad \Gamma, \rho : P_i \vdash t_i \equiv t'_i : \Sub{B}{a}{c_i\,\rho} \quad (1 \leq i \leq n) \qquad \Gamma \vdash v \equiv v' : (c_1 : P_1 \oplus ... \oplus c_n : P_n)_{w:P}}
